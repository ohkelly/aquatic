...
if option == "Dashboard":
    ...
    energy_data = "https://raw.githubusercontent.com/ohkelly/aquatic/main/data/energy_data.csv"
    water_quality_data = "https://raw.githubusercontent.com/ohkelly/aquatic/main/data/sensor_data.csv"
...
# Assistant View
    ...
    st.title("Ask the AI Assistant everything on your Aquaponics System energy and climate control -Co2 emissions")
